...
public class Test11 {
    public static void main(String[] args) throws ClassNotFoundException, NoSuchFieldException {
        ...
        for (Annotation annotation : annotations) {
            System.out.println(annotation);  //@com.company.reflection.Tablekuang("db_student")
        }
...
class Student2 {
    ...
    private int id;
    @Fieldkuang(columnName = "db_age",type = "int",length = 20)
    private int age;
    @Fieldkuang(columnName = "db_name",type = "varchar",length = 30)
    private String name;
